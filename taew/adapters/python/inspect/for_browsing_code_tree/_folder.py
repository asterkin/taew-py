...
from taew.adapters.python.path.for_browsing_code_tree.folder import Folder as FolderBase
...
class Folder(FolderBase):
    def __init__(self, root_path: Path, name_prefix: Optional[str] = None) -> None:
        super().__init__(
            root_path,
